...
-- 5 КЕЙСОВ
local cases = {"Bloody Night", "Heavenfall", "Marina", "Cursed Demon", "Photon Core"}
...
SelectedCaseLabel.Position = UDim2.new(0.05, 0, 0.21, 0)
...
SellToggle.Position = UDim2.new(0.05, 0, 0.33, 0)
...
SellStatus.Position = UDim2.new(0.52, 0, 0.33, 0)
...
Auto.Position = UDim2.new(0.05, 0, 0.48, 0)
...
FarmStatus.Position = UDim2.new(0.05, 0, 0.66, 0)
FarmStatus.Size = UDim2.new(0, 270, 0, 20)
...
CounterLabel.Position = UDim2.new(0.05, 0, 0.74, 0)
CounterLabel.Size = UDim2.new(0, 270, 0, 20)
...
CaseListFrame.Size = UDim2.new(0, 250, 0, 250)

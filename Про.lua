...
local function ShowPasswordPrompt()
    ...
    PasswordBox.BackgroundColor3 = Color3.fromRGB(30, 25, 50)
    PasswordBox.BorderColor3 = Color3.fromRGB(150, 255, 100)
    ...
    LoginBtn.BackgroundColor3 = Color3.fromRGB(100, 200, 50)
    LoginBtn.BorderColor3 = Color3.fromRGB(150, 255, 100)
    ...
    local CorrectPassword = "mr.comcom"
    local result = nil
    
    LoginBtn.MouseButton1Click:Connect(function()
        if PasswordBox.Text == CorrectPassword then
            StatusLabel.Text = "✅ ПАРОЛЬ ВЕРНЫЙ!"
...
local function LoadMainScript()
    ...
    SellBtn.Position = UDim2.new(0.05, 0, 0.68, 0)
    ...
    StartBtn.Position = UDim2.new(0.52, 0, 0.68, 0)
    ...
    InfoLabel.Text = "👑 @NoMentalProblem & @Vezqx\n📢 TG: TonBattleScript"
    InfoLabel.TextColor3 = Color3.fromRGB(180, 0, 255)
    InfoLabel.TextSize = 10
    
    -- ФУНКЦИИ (ваш рабочий код)
    ...
    print("✅ СКРИПТ ЗАГРУЖЕН | Кейс: " .. Config.SelectedCase)
end
